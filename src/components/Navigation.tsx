  ...
  return (
    <nav className={`backdrop-blur-md sticky top-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        <div className={`lg:hidden transition-all duration-300 ease-in-out relative z-20 ${
          isMenuOpen 
            ? 'max-h-96 opacity-100 translate-y-0' 
            : 'max-h-0 opacity-0 -translate-y-4'
        } overflow-hidden`}>
          <div className="py-4 space-y-2 border-t border-gray-200 bg-white/95 backdrop-blur-md shadow-lg">
            <Link
              href="/about"
              onClick={closeMenu}
